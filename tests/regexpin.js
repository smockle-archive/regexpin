...
test('regexpIn', (t) => {
  ...
  t.equal(
    regexpIn(
      ['a', 'b'],
      Immutable.Map({ 'a': Immutable.Map({ 'b': m3 }) })
    ),
    m3,
  ...
  t.equal(
    regexpIn(Immutable.Set(['a', 'b']))(Immutable.Map({ 'a': Immutable.Map({ 'b': 3 }) })),
    3,
  ...
  t.equal(
    regexpIn(Immutable.Set(['z', 'b']))(Immutable.Map({ 'a': Immutable.Map({ 'b': 3 }) })),
    undefined,
  ...
  t.equal(
    regexpIn(Immutable.Set(['a', 'b']))(Immutable.Map({ 'a': Immutable.Map({ 'b': m8 }) })),
    m8,
